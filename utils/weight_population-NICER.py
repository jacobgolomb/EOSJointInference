...
parser.add_argument('--gmm-files', '--fits', '-f', type=str, help="Path to list of gmm fits")
...
gmm_files = np.loadtxt(args.gmm_files, dtype=str)
n_events = len(gmm_files)
...
def get_pop_weight(params):
    return models.get_pulsar_mass_weights(mass_samples, pdraw_population_samples, 
                            params['mmin'], params['mpop'], params['mu1'], params['mu2'], params['sigma1'], params['sigma2'], params['frac1'])
